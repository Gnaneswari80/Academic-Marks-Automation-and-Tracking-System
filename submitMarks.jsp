...
int safeParse(String s) {
    if(s == null || s.trim().isEmpty()) return 0;   // empty → 0
    try { return Integer.parseInt(s.trim()); } 
    catch(Exception e) { return 0; }                // invalid → 0
}
%>
...
<%
    ...
    "marks_6a","marks_6b"
        ...
        for(String sid : studentIds){
            ...
            if(rs.next()){
            	//System.out.println("---- SUBMIT MARKS STARTED ----");
                ...
                for(String col: cols){
                    ...
                    if(val == null || val.trim().isEmpty()){
                        val = "0";   // missing/empty → save 0
                    }

                    ups.setInt(idx++, safeParse(val));
                  //  System.out.println("Saving " + sid + " " + col + "=" + val);
                ...
                for(String col: cols){
                	String val = request.getParameter(sid + "_" + col);
                	if(val == null || val.trim().isEmpty()) {
                	    val = "0"; // treat new empty fields as 0
                	}
